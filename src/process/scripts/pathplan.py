...
def UpdateImage():
    ...
    if (FLAG_rotate == True):
        ...
        cv2.putText(img_show, 'Real(z)' if FLAG_realMove else 'Simulate(z)', (10, 290), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (181, 24, 37) if FLAG_realMove else (174, 214, 51), 1, cv2.LINE_AA)
...
if __name__ == "__main__":
    ...
    rospy.Service('/pathplan/command', String, handle_commands)
