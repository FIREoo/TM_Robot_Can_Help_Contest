...
class VideoThread(QThread):
    ...
    def send_command(self, cmd):
        ...
        try:
            send_command_service = rospy.ServiceProxy('/pathplan/command', SendScript)
            resp1 = send_command_service('cmd_status', cmd)
            return resp1.data
...
class App(QtWidgets.QMainWindow):
    ...
    def setupUi(self):
        ...
        self.pauseButton.setEnabled(True)  #enable
        ...
        self.stopButton.setEnabled(True)  #enable
        ...
        self.startButton.setEnabled(True)  #enable
        ...
        self.removeButton.setEnabled(True)  #enable
        ...
        self.detectButton.setEnabled(True)  #enable
        ...
        self.thread.img_plan_signal.connect(self.update_sim_image)
        self.thread.img_yolo_signal.connect(self.update_yolo_image)
        self.thread.img_hand_signal.connect(self.update_real_image)
        self.thread.start()

    @pyqtSlot(np.ndarray)
    def update_sim_image(self, image):
        self.simImage.setPixmap(self.convert_cv_qt(image, 300, 400))
