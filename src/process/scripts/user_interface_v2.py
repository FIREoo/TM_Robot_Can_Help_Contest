...
class VideoThread(QThread):
    ...
    def send_command(self, cmd):
        ...
        try:
            ...
            resp1 = send_command_service("cmd", cmd)
            return resp1.data
    ...
    def run(self):
        ...
        rospy.Subscriber('/tm_yolo/image', Image, self.img_tm_yolo_callback, queue_size=1)
...
class App(QtWidgets.QMainWindow):
    ...
    def retranslateUi(self):
        ...
        self.realLabel.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:14pt; font-weight:600;\">TM-YOLO</span></p></body></html>"))
        ...
        self.mainTitle.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:46pt; font-weight:600;\">ROBOT CAN HELP</span></p></body></html>"))
